...
def _rust_ast_backend():
    global _ast_rs
    if _ast_rs is None:
        try:
            import _ast_rs as backend
        except ImportError:
            return None
        _ast_rs = backend
    return _ast_rs
...
def iter_fields(node):
    ...
    """
    rust = _rust_ast_backend()
    if rust is not None:
        yield from rust.iter_fields(node)
        return
...
def iter_child_nodes(node):
    ...
    rust = _rust_ast_backend()
    if rust is not None:
        yield from rust.iter_child_nodes(node)
        return
...
class NodeVisitor(object):
    ...
    def generic_visit(self, node):
        ...
        rust = _rust_ast_backend()
        if rust is not None:
            return rust.visitor_generic_visit(self, node)
...
class NodeTransformer(NodeVisitor):
    ...
    def generic_visit(self, node):
        rust = _rust_ast_backend()
        if rust is not None:
            return rust.transformer_generic_visit(self, node)
