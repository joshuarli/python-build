    ...
    class _RustDecompressor:
        ...
        def eof(self):
            if self._native is not None:
                return self._native.eof
            return _gzip_rs.eof(self._state)

        @property
        def needs_input(self):
            if self._native is not None:
                return self._native.needs_input
            return _gzip_rs.needs_input(self._state)

        @property
        def unused_data(self):
            if self._native is not None:
                return self._native.unused_data
            return _gzip_rs.unused_data(self._state)

        def decompress(self, data, max_length=0):
            if self._native is not None:
                return self._native.decompress(data, max_length)
            try:
    ...
    def __init__(self, filename=None, mode=None,
        ...
        try:
            ...
            if mode.startswith('r'):
                ...
                self.compress = _new_compressor(compresslevel)
