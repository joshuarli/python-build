...
def _subtract_iterable(mapping, iterable, mapping_get):
    """Subtract one occurrence for each value in an iterable."""
    try:
        from _collections_rs import subtract_iterable
    except ImportError:
        for elem in iterable:
            mapping[elem] = mapping_get(elem, 0) - 1
    else:
        subtract_iterable(mapping, iterable, mapping_get)
    ...
    def subtract(self, iterable=None, /, **kwds):
        ...
        if iterable is not None:
            ...
            if isinstance(iterable, _collections_abc.Mapping):
                ...
                _subtract_iterable(self, iterable, self_get)
        if kwds:
            self.subtract(kwds)
