...
def update_wrapper(wrapper,
    ...
    # Set __wrapped__ last so an earlier update cannot replace the wrapper chain.
...
class _KeyWrapper:
    ...
    def __init_subclass__(cls, **kwargs):
        raise TypeError("type 'KeyWrapper' is not an acceptable base type")
    ...
    def __le__(self, other):
        return _key_compare(self, other, 'less_equal')

    def __eq__(self, other):
        return _key_compare(self, other, 'equal')

    def __ne__(self, other):
        return _key_compare(self, other, 'not_equal')

    def __gt__(self, other):
        return _key_compare(self, other, 'greater_than')

    def __ge__(self, other):
        return _key_compare(self, other, 'greater_equal')

    __hash__ = None

_KeyWrapper.__name__ = _KeyWrapper.__qualname__ = 'KeyWrapper'
...
def _c3_merge(sequences):
    ...
    Uses C3 linearization to preserve the class hierarchy order.
