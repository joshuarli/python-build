...
def _rust_wrap_eligible(wrapper, text):
    ...
    if (type(wrapper) is not TextWrapper or type(text) is not str or
            ...
            wrapper.expand_tabs is not True or
            wrapper.replace_whitespace is not True or
            wrapper.fix_sentence_endings is not False or
            wrapper.break_long_words is not True or
            wrapper.drop_whitespace is not True or
